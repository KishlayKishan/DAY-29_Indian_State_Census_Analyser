...
public class StateCensusAnalyser {
	...
	public static Iterator<Object> getIterator(String csvFilePath, Object myClass) throws CensusAnalyserException {
		...
		try {
			...
			CsvToBeanBuilder<Object> csvToBeanBuilder = new CsvToBeanBuilder<Object>(reader);
			csvToBeanBuilder.withType(extracted(myClass));
	...
	private static Class<?> extracted(Object myClass) {
